...
class _$_AuthUser implements _AuthUser {
  ...
  @override
  String toString() {
    return 'AuthUser(id: $id, username: $username, password: $password, email: $email, firstName: $firstName, lastName: $lastName, gender: $gender, image: $image, token: $token)';
  }
...
abstract class _AuthUser implements AuthUser {
  factory _AuthUser(
      ...
      final String gender,
      final String image,
      final String token}) = _$_AuthUser;
